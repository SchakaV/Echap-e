...
// Aucune dépendance DOM : le journal est fourni par l'appelant via une
// fonction `log(html)` (ui.appendLog en solo, room.addLog côté serveur), ce
// qui permet au serveur multijoueur (Node) d'exécuter ce module tel quel.
 ...
 *
 * `log` : fonction(html) appelée pour chaque ligne de journal (DOM en solo,
 * journal de salle côté serveur multijoueur).
 */
