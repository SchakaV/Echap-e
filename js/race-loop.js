...
function runStartOfTurn(rider) {
  ...
  // Le journal d'événement est une fonction injectable (compatible serveur) :
  // en solo, chaque ligne est ajoutée au DOM du journal de course.
  return events.processStartOfTurn(App.runtime.state, rider,
    (html) => ui.appendLog($('#log-content'), html));
}
